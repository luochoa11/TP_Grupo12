...
public class Constantes {
    ...
    public static final int PUERTO_SERVIDOR_CENTRAL = 8000;
    public static final int PUERTO_SERVIDOR_B = 8001;
    ...
    public static final String HOST_SERVIDOR_B = "localhost";
